...
seriesOrder: 1
startHere: true
concepts: ["quality-loop", "ai-testing", "failure-triage", "execution-evidence"]
links: ["terminal-agent-interface", "ai-supply-chain-incident-triage"]
aliases: ["AI QA", "AI-assisted testing", "failure triage"]
updatedReason: "Initial publication; defines QA as a learning loop rather than click automation."
---
