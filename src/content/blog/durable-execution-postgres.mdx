...
aliases: ["durable execution", "Postgres workflows", "recovery semantics"]
updatedReason: "Initial publication; compares durable execution mechanisms and system boundaries."
---
